...
const MainCareuselForm = () => {
   ...
   useEffect(() => {
    if (id) {
      const fetchItem = async () => {
        try {
          const res = await fetch(`/api/MainCareusel/${id}`)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        id ? `/api/MainCareusel/${id}` : '/api/MainCareusel',
        {
          method: id ? 'PUT' : 'POST',
          body: formData
        }
  ...
  return (
    <Card>
      <CardHeader title={id ? 'Edit Careusel' : 'Create Careusel'} />
      <CardContent>
...
export default MainCareuselForm
